...
const CartComponent = (item) => {
    const { cart, setCart, actualizarTotal, removeItem, clearCart, cantidad} = useContext(cartContext);
                ...
                <div className={ cart.length === 0 ? "" : "container_carrito"}>
                    ...
                    <div style={{display:'flex', flexDirection:'column'}}> 
                                        ...
                                        <div className='cart_product'>
                                            ...
                                            <div className='cart_product_info'>
                                                ...
                                                <div className='talla_color'>
                                                    <span className='product_color'> Color:  {elemento.item.colors} </span>
                        ...
                        <div>
                            ...
                            <Link to="/catalogo">
                                <Button inverted size='mini' color='grey' style={{marginTop:'15px', fontSize:'15px', color:'#00532c'}} > 
                                    Continuar comprando
                                </Button>
                            </Link>
                        </div>
